...
async def youtube_dl_call_back(client, callback_query):
    cb_data = callback_query.data
    # youtube_dl extractors
    tg_send_type, youtube_dl_format, youtube_dl_ext = cb_data.split("|")
    save_ytdl_json_path = Config.DOWNLOAD_LOCATION + \
        "/" + str(callback_query.from_user.id) + ".json"
    try:
    ...
    if t_response:
        ...
        if file_size > Config.TG_MAX_FILE_SIZE:
            ...
            if tg_send_type == "audio":
                ...
                thumbnail = await Gthumb01(client, callback_query)
                ...
                thumbnail = await Gthumb02(client, callback_query, duration, download_directory)
